...
void sd_handleFileUpload()
{
  ...
  if (upload.status == UPLOAD_FILE_START)
  {
    ...
    SD_FS_PRINTF("Upload: START, filename: ");
    SD_FS_PRINTFLN("%s", upload.filename);
  }
  else if (upload.status == UPLOAD_FILE_WRITE)
  {
    ...
    SD_FS_PRINTF("Upload: WRITE, Bytes: ");
    SD_FS_PRINTFLN("%u", upload.currentSize);
  }
  else if (upload.status == UPLOAD_FILE_END)
  {
    ...
    SD_FS_PRINTF("Upload: END, Size: ");
    SD_FS_PRINTFLN("%u", upload.totalSize);
  }
}
